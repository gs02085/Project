	...
	<div class="section">
		...
		<div class="SellProduct">
			...
			<a href="ProductListDelte?pseq=${Sellproduct[i].pseq}" onclick="return checkDelte();">
				...
				<div class="item">
					<table border="1" style="height:300px;width:220px; ">
						<tr>
							<td align="center" style="height: 20%;margin;">
								<p  style="text-align: center;" class="itemSource">이름
								<p>
							</td>
							<td style="height: 20%; margin:0%;word-break:keep-all;word-wrap:break-word">
								<p class="itemSource2" >${Sellproduct[i].name}</p>
							</td>
						</tr>
						<tr >
							<td style="height: 20%;margin:0%;">
								<p  style="text-align: center;" class="itemSource">원가</p>
							</td>
							<td style="height: 20%;">
						...
						<tr>
							<td style="height: 20%;margin:0%;" >
								<p   style="text-align: center;"class="itemSource">판매가</p>
							</td>
							<td style="height: 20%;margin:0%;">
						...
						<tr>
							<td style="height: 20%;margin:0%;">
								<p   style="text-align: center;"class="itemSource">재고현황</p>
							</td>
							<td style="height: 20%;margin:0%;">
						...
						<tr>
							<td style="height: 20%;margin:0%;">
								<p  style="text-align: center;" class="itemSource">누적판매수량</p>
							</td>
							<td style="height: 20%;margin:0%;">
								<p class="itemSource2">${sumSaleCount[i]}개</p>
							</td>
						</tr>
					</table>
				</div>
				...
				<div class="item">
					<table border="1">
						...
						<tr>
							...
							<td style="height: 20%;margin:0%;">
								<p class="itemSource2">${sumSaleCount2[i]}개</p>
							</td>
						</tr>
					</table>
				</div>
