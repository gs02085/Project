				...
				<table class="register" border=1 align=center cellspacing=1
					...
					<tr>
						...
						<td colspan=5><div id="detail">
							...
							<c:choose>
							<c:when test="${posting2[0].getFramList().get(i).fseq==samllFseq}">
										<textarea rows="" cols="" id="detail" name="experience_context"
									size=200 maxlength=250 style="width: 383px; height: 221px;">
									${posting2[0].getFramList().get(i).experience_context}
									</textarea>
									</c:when>
									</c:choose>
									</c:forEach>
