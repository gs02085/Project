...
<article style="margin-top: 100px;">
		<h1 style=" position:relative; left: 30%;">
	<!-- true가 되어야 전송이 가능한 것, 투르가 아니면 전송을 못함 -->Seller 회원 가입</h1>
...
<tr><td colspan=2 height=2 background="dot.gif"></td></tr>
<tr>
   <td style="width: 130px;"colspan=1 bgcolor=#99ccff align=center>이름</td>
...
<tr>
   <td bgcolor=#99ccff align=center>비밀번호</td>
   <td> 
...
<tr>
   <td colspan=2 bgcolor=white align=center height=30>   
      ...
      <input type=reset value=다시입력> 
       <input type='reset' value='취소' onclick='location.href= "Slogin"' />  
   </td>
</tr>
</table>
</fieldset>
